...
def main():
    ...
    dataset.create(24,25)   #chaque dataset.create a une durée d'environ 3h20
    #dataset.create(25,26)
    #dataset.create(26,27)
    #dataset.create(27,28)
    #dataset.create(28,29)
    #dataset.create(29,30)
    #dataset.create(30,31)
    #dataset.create(31,32)
    #dataset.create(32,33)
    #dataset.create(33,34)
    #dataset.create(34,35)
    #dataset.create(35,36)
