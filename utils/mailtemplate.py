...
<![endif]-->
  ...
  <title></title>
    ...
    <style type="text/css">
      table, td {{ color: #000000; }} a {{ color: #0000ee; text-decoration: underline; }} @media (max-width: 480px) {{ #u_content_image_2 .v-src-width {{ width: 626px !important; }} #u_content_image_2 .v-src-max-width {{ max-width: 100% !important; }} }}
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="cid:{cid}" alt="finish Image" title="finish Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 77%;max-width: 462px;" width="462" class="v-src-width v-src-max-width"/>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 22px; line-height: 30.8px; color: #2a9d8f;"><strong>YOUR REPORT HAVE BEEN GENERATED</strong></span></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #264653; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 16px; line-height: 22.4px;"><strong>Hi {receiver_name}, </strong></span></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #264653; line-height: 160%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><span style="font-family: Lato, sans-serif;">Your report has been successfuly generated. You may found it using the following link: <a rel="noopener" href="{report_link}" target="_blank">{report_link}</a></span></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #264653; line-height: 140%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><strong>All the results found will be displayed there, including:</strong></p>
  </div>
...
<li style="font-size: 14px; line-height: 25.2px;"><span style="font-size: 14px; line-height: 25.2px; font-family: Lato, sans-serif;">An overall result</span></li>
<li style="font-size: 14px; line-height: 25.2px;"><span style="font-size: 14px; line-height: 25.2px; font-family: Lato, sans-serif;">The result of all algorithm ask to be runned</span></li>
<li style="font-size: 14px; line-height: 25.2px;"><span style="font-size: 14px; line-height: 25.2px; font-family: Lato, sans-serif;">A reminder of the initial problem</span></li>
<li style="font-size: 14px; line-height: 25.2px;"><span style="font-size: 14px; line-height: 25.2px; font-family: Lato, sans-serif;">The evolution of the solutions found (so it will not be a black box for you)</span></li>
</ul>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #264653; line-height: 160%; text-align: left; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 160%;"><strong><span style="font-family: Lato, sans-serif; font-size: 14px; line-height: 22.4px; color: #264653;">If you have any questions, just email us at <span style="color: #34495e; font-size: 14px; line-height: 22.4px;"><a rel="noopener" href="https://unlayer.com/" target="_blank">cvrp.ai50@gmail.com</a></span></span></strong></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  <tbody>
    <tr>
      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px 10px 30px 30px;font-family:'Montserrat',sans-serif;" align="left">
