...
public class ListenerAgent extends Agent {
  ...
  @SyntheticMember
  public ListenerAgent(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public ListenerAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
