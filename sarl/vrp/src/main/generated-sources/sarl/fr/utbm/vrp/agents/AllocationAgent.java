...
import fr.utbm.vrp.agents.VehicleAgent;
import fr.utbm.vrp.agents.customerInserted;
import fr.utbm.vrp.agents.customerRelocated;
import fr.utbm.vrp.agents.finish;
import fr.utbm.vrp.agents.finishVehicle;
import fr.utbm.vrp.agents.insertCustomer;
    ...
    synchronized (this) {
      ...
      if (((this.number_vehicle != null && this.number_agent_returned == this.number_vehicle.doubleValue()) && (this.best_insertion_cost < Integer.MAX_VALUE))) {
        ...
        if ((this.number_vehicle != null && this.number_agent_returned == this.number_vehicle.doubleValue())) {
          ...
          this.number_agent_returned = 0;
          DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER();
          vehicleInserted _vehicleInserted = new vehicleInserted();
          class $SerializableClosureProxy_1 implements Scope<Address> {
          ...
          _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_vehicleInserted, _function_1);
          UUID vehicleUUID = UUID.randomUUID();
          Lifecycle _$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER = this.$CAPACITY_USE$IO_SARL_CORE_LIFECYCLE$CALLER();
          InnerContextAccess _$CAPACITY_USE$IO_SARL_CORE_INNERCONTEXTACCESS$CALLER_1 = this.$CAPACITY_USE$IO_SARL_CORE_INNERCONTEXTACCESS$CALLER();
          ...
          _$CAPACITY_USE$IO_SARL_CORE_SCHEDULES$CALLER_1.every(task, 100, _function_2);
        }
      }
    }
  }
